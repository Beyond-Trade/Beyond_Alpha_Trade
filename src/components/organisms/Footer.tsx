    ...
    <div className="bg-customBlack-500 px-20 pt-16 mt-5 text-white">
      <div className="font-normal text-lg xxl:text-xl lg:flex">
        ...
        <div className="flex flex-col mt-6 lg:mt-1 items-start pr-20">
          ...
          <NavLink to="/market" className="mt-4 cursor-pointer">
            Market
          </NavLink>
          <NavLink to="/trade" className="mt-4 cursor-pointer">
            Trade
          </NavLink>
          <NavLink to="/loan" className="mt-4 cursor-pointer">
            Loan
          </NavLink>
        </div>
        <div className="flex flex-col mt-6 lg:mt-1 items-start pr-20">
          ...
          <a
            className="mt-4 cursor-pointer"
            href="http://beyondfinance.io/about"
            target="_blank"
            rel="noopener noreferrer"
          >
            About
          ...
          <a
            className="mt-4 cursor-pointer"
            href="mailto:contact@beyondfinance.io"
            target="_blank"
            rel="noopener noreferrer"
          >
            Contact us
        ...
        <Modal isOpen={isOpen} style={customStyle}>
          ...
          <div className="flex text-center items-center  pb-2 text-red-600 font-bold"></div>
