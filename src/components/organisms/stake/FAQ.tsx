    ...
    <div className="px-20 py-12">
          ...
          faqNo={4}
            ...
            answer={
              <p>
                ...
                <br />
                • Adoption of BIP for community voting (ex. fee sharing ratio,
                new asset creations)
                <br />
                2Q 2021 – New asset class introduction of unlisted private
                stocks, IEOs and probability events Future & Options update{" "}
                <br />
                ...
                1H 2022 – Completion of full Decentralized Autonomous
          ...
          faqNo={6}
            ...
            answer={
              <p>
                ...
                <br />
                Step 2 - Stake the BYN Token and get Staking reward OR - Issued
                with Synthetic Token USDb.
                <br />
          ...
          faqNo={7}
            ...
            answer={
              <p>
                ...
                <br />
                2. Staking BYN allows the BYN holder to invest (mint) synthetic
                assets and earn additional rewards in BYN.
                <br />
                3. Stake BYN to earn the portion of trading fee from the Beyond
                Exchange. <br />
                Further if the BYN holder, stakes at least 50,000 BYN, the
                staker is eligible to participate in the Beyond Governance via
      ...
      <div className="flex">
        <div>
          ...
          <GeneralButton
            submitting={false}
            submit={() =>window.open("mailto:contact@beyondfinance.io", "_blank")}
            textValue={"Contact Us"}
            otherClasses={
              "bg-customBlack-500 mt-4 px-4 py-2 xxl:text-lg text-xs"
            }
          />
        </div>
        {/* <div> <img
