      ...
      <div className="bg-customGray-100 rounded mr-8 w-full">
        <div className="rounded-t flex justify-between items-center bg-gray-300 text-gray-600 xl:text-xs xxl:text-sm px-2 py-2 font-medium">
          <div className="flex items-center ">
            ...
            <div className="xl:ml-12 xxl:ml-32 bg-gray-400 py-1 px-4 mr-4 rounded-sm cursor-pointer">
              sETH
            </div>
        ...
        <div className="flex justify-between p-4">
          <div className="flex justify-between xl:text-xs xxl:text-base w-full">
            <div>
              ...
              <h3 className="text-gray-600 py-2">sETH LIMIT</h3>
              <h3 className="text-gray-600 py-2">sETH SUPPLY</h3>
            </div>
            <div>
