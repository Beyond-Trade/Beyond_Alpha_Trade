  ...
  return (
    <>
      <div className="bg-customGray-100 rounded mr-8 w-full mt-3">
        <div className="rounded-t flex justify-between items-center bg-gray-300 text-gray-600 text-xs px-2 py-3 font-medium">
          <h5>YOUR WALET</h5>
        </div>
        <div className="flex justify-between p-4">
          <div className="flex justify-between w-full">
            <div>
              <h3 className="text-xs text-gray-600 py-2">sETH BALANCE</h3>
            </div>
            <div>
