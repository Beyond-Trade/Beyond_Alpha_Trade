  ...
  return (
    <div>
      ...
      <div className=" px-20 py-12">
        <h1 className="xl:text-2xl xxl:text-4xl xl:pt-4 xxl:pt-8 font-bold text-customBlue-500">
          FREQUENTLY ASKED QUESTIONS (FAQs)
        </h1>
        <p className="xl:text-xxs xxl:text-lg py-6 mt-3 text-customBlue-500">
        ...
        <h2 className="font-bold mt-12 xl:text-xl xxl:text-3xl text-customBlue-500">
          Didn't find an answer?
        </h2>
        <p className="xl:text-xs xxl:text-lg my-6 text-customBlue-500">
