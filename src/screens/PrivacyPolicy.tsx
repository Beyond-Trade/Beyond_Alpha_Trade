    ...
    <div>
      ...
      <div className=" px-8 md:px-16 xl:px-24 lg:px-24 mt-8 xl:text-xs xxl:text-lg">
        ...
        <p className="items-center text-center justify-center">
          At Beyond Exchange, accessible from
          https://warm-inlet-70613.herokuapp.com/, one of our main priorities is
          the privacy of our visitors. This Privacy Policy document contains
          types of information that is collected and recorded by Beyond Exchange
          and how we use it.
        </p>
        ...
        <p className="items-center text-center justify-center">
          ...
          shared and/or collect in Beyond Exchange. This policy is not
        ...
        <p className="items-center text-center justify-center">
          At Beyond Exchange, accessible from www.beyondexchange.com, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by Beyond Exchange and how we use it. If you have additional questions
          or require more information about our Privacy Policy, do not hesitate
          to contact us.
        </p>
        <p className="items-center text-center justify-center mt-3">
          This Privacy Policy applies only to our online activities and is valid
          for visitors to our website with regards to the information that they
          shared and/or collect in Beyond Exchange. This policy is not
          applicable to any information collected offline or via channels other
        ...
        <ol className="ml-5">
          <li className="items-center justify-center my-2">
          ...
          <li className="items-center justify-center my-2">Send you emails</li>
          <li className="items-center justify-center my-2">
        ...
        <p className="items-center text-center justify-center">
          Beyond Exchange follows a standard procedure of using log files. These
        ...
        <p className="items-center text-center justify-center">
          Like any other website, Beyond Exchange uses 'cookies'. These cookies
        ...
        <p className="items-center text-center justify-center">
          ...
          advertising partners of Beyond Exchange.
        </p>
        <p className="items-center text-center justify-center my-3">
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on Beyond Exchange, which are
        ...
        <p className="items-center text-center justify-center">
          Note that Beyond Exchange has no access to or control over these
        ...
        <p className="items-center text-center justify-center">
          Beyond Exchange's Privacy Policy does not apply to other advertisers
        ...
        <p className="items-center text-center justify-center">
          Beyond Exchange does not knowingly collect any Personal Identifiable
